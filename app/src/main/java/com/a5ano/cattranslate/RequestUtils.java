...
/**
 * Created by yili on 2016/9/22 0026.
 */

public class RequestUtils {
    private static final String UTF8 = "utf-8";

    //申请者开发者id，修改成自己的appid
    private static final String appId = "20160921000029051";

    //申请成功后的证书token，修改成自己的token
    private static final String token = "hJU7xJcXm_oDgyOp0lNt";
