...
public class youdao extends AppCompatActivity {
    ...
    private String YouDaoKeyFrom = "JellyTrans";
    private String YouDaoKey = "329896330";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit = (EditText) findViewById(R.id.editText_Input);
        search = (FloatingActionButton) findViewById(R.id.fab);
        search.setOnClickListener(new searchListener());
        text = (TextView) findViewById(R.id.editText_Result);
    ...
    private class searchListener implements OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (content == null || "".equals(content)) {
                Snackbar.make(search, "请输入要翻译的内容", Snackbar.LENGTH_LONG)
                        .show();
                return;
            }
    ...
    private void AnalyzingOfJson(String url) throws Exception {
        ...
        if (httpResponse.getStatusLine().getStatusCode() == 200) {
            ...
            Snackbar.make(search, "已获取翻译结果", Snackbar.LENGTH_LONG)
                    .setAction("复制翻译结果", new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            ClipboardManager clip = (ClipboardManager) getSystemService(Context.CLIPBOARD_SERVICE);
                            clip.setText(text.getText());
                            Snackbar.make(search, "已复制翻译结果", Snackbar.LENGTH_LONG)
                                    .show();
                        }
                    })
